    ...
    <main className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-sm border p-8 text-center space-y-4">
        ...
        <p className="text-slate-600">
          Thank you for completing the Trident Maturity Assessment. Your responses have been securely recorded and will be compiled into the final stakeholder report.
        </p>
      </div>
    </main>
  );
